          ...
          <div class="row justify-content-center">
            <div class="col-md-6">
              <div class="panel panel-default">
                <div class="panel-heading"><h3>회원수정</h3></div>
                  ...
                  <form action="/member/modify" id="modifyForm" method="post" role="form">
					...
					<div class="row align-items-center">
						<div class="form-group col-md-12 mb-3">
							<label for="">아이디</label>
							<!--아래 코드 실행시 jdbc타입 부적합한 열 유형 1111 오류발생-->
							<!-- <div class="form-control text-left py-0">${memberVO.mbsp_id}</div> -->    
					...
					<!-- 회원가입 -->
                    <button type="submit" id="btn_modify" class="btn btn-primary btn-block">변경</button>
                  </form>
                </div>
              </div>
            </div>
