                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="form-group row">
                              ...
                              <form id="searchForm" action="/admin/product/pro_list" method="get">
                                ...
                                <!-- <input type="hidden" name="pageNum" value="1">
                                <input type="hidden" name="amount" value="${pageMaker.cri.amount}"> -->
                                <!-- <button type="submit"  class="btn btn-primary"><i class="fal fa-search fs-xl"></i>검색</button> -->
                               </form>
                              ...
                              <div class="col-md-2">
                               <button type="button"  id="categorySearch" class="btn btn-primary">검색</button>
                              </div>
                              <div class="col-md-2">
                          ...
                          <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">상품코드</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">상품이미지</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">상품명</font></th>
                                    <th style="text-align: center; width: 10%"><font style="vertical-align: inherit; ">가격</font></th>
                                    <th style="text-align: center; width: 10%"><font style="vertical-align: inherit; ">할인율</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">판매여부 Y / N</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">등록일</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">수정</font></th>
                                    <th style="text-align: center;"><font style="vertical-align: inherit; ">삭제</font></th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${pro_list}" var="productVO">
                                    <tr>
                                        <td style="text-align: center; vertical-align: middle;"><input type="checkbox" name="check" value="${productVO.pro_num}"></td>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a class="move" href="${productVO.pro_num}">
                                                <img src="/admin/product/displayImage?folderName=${productVO.pro_up_folder}&fileName=s_${productVO.pro_img}">
                                            </a>
                                        </td>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            <div class="input-group input-group-multi-transition">
                                                ...
                                                <input type="text" class="form-control" aria-label="" name="pro_price" value="${productVO.pro_price}">
                                            </div>
                                        </td>
                                        
                                        <td style="text-align: center; vertical-align: middle;">
                                            <div class="input-group input-group-multi-transition">
                                                <input type="text" class="form-control" aria-label="" name="pro_discount" value="${productVO.pro_discount}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">%</font></font></span>
                                                </div>
                                            </div>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            등록일: <fmt:formatDate value="${productVO.pro_date}" pattern="yyyy-MM-dd HH:mm"/><br>
                                            <c:if test="${productVO.pro_updatedate != productVO.pro_date}">
                                            수정일: <fmt:formatDate value="${productVO.pro_updatedate}" pattern="yyyy-MM-dd HH:mm"/>
                                            </c:if>
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <button type="button" name="btn_productEdit" data-pro_num="${productVO.pro_num}" class="btn btn-link">수정</button>
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <button type="button" name="btn_productDel" data-pro_num="${productVO.pro_num}" class="btn btn-link">삭제</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("a.move").on("click", function (e){
                    e.preventDefault(); // a태그 하이퍼링크 기능 취소
                ...
                $("#btn_checkedModify").on("click", function(){
                    ...
                    if(!confirm("선택된 상품을 수정 하시겠습니까?")) return;

                    console.log("동작유무 체크")

                    // 자바스크립트 배열문법
                    let pro_num_arr = [];       //수정할 상품 코드 배열
                    let pro_price_arr = [];     //수정할 상품 가격 배열
                    let pro_discount_arr = [];  //수정할 상품 할인 배열
                    let pro_buy_arr = [];       //수정할 상품 판매여부 배열
                    ...
                    $.ajax({
                        ...
                        data : { pro_num_arr: pro_num_arr,
                                 ...
                                 pro_discount_arr : pro_discount_arr,
