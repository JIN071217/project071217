                ...
                <div class="page-content-wrapper">
                    ...
                    <!-- 카테고리 데이터 입력-->
                        ...
                        <div class="input-group input-group-multi-transition">
                            ...
                            <input type="text" class="form-control" aria-label="" id="pro_price" name="pro_price" placeholder="판매금액">
                            <input type="text" class="form-control" aria-label="" id="pro_discount" name="pro_discount" placeholder="할인율">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pro_amount" name="pro_amount" class="form-control">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="pro_content" name="pro_content"rows="5"></textarea>
                        </div>
