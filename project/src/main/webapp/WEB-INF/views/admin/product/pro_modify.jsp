    ...
    <body class="mod-bg-1 mod-nav-link ">
                           ...
                           <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="ui_badges.html" title="Badges" data-filter-tags="ui components badges">
                                            <span class="nav-link-text" data-i18n="nav.ui_components_badges">미구현</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="ui_breadcrumbs.html" title="Breadcrumbs" data-filter-tags="ui components breadcrumbs">
                                            <span class="nav-link-text" data-i18n="nav.ui_components_breadcrumbs">미구현</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="ui_buttons.html" title="Buttons" data-filter-tags="ui components buttons">
                                            <span class="nav-link-text" data-i18n="nav.ui_components_buttons">미구현</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="#" title="Form Stuff" data-filter-tags="form stuff">
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.form_stuff">미구현</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="nav-title">추후 추가적인기능 추가구현(예정)</li>
                            <li>
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control" name="cat_prtcode" id="firstCategory">
                                    <option selected="">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">1차 카테고리</font>
                                        </font>
                                    </option>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select class="custom-select form-control" name="cat_code" id="secondCategory">
                                    <option selected="">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">2차 카테고리</font>
                                        </font>
                                    </option>
                    ...
                    <!-- 카테고리 데이터 입력-->
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">상품명</font>
                                        </font>
                                    </label>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">제조사</font>
                                        </font>
                                    </label>
                                    <input type="text" id="pro_publisher" name="pro_publisher" class="form-control" value="${productVO.pro_publisher}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group input-group-multi-transition">
                            ...
                            <input type="text" class="form-control" aria-label="" id="pro_price" name="pro_price" value="${productVO.pro_price}" placeholder="판매금액">
                            <input type="text" class="form-control" aria-label="" id="pro_discount" name="pro_discount"  value="${productVO.pro_discount}" placeholder="할인율">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pro_amount" name="pro_amount" class="form-control" value="${productVO.pro_amount}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="form-label" for="inputGroupFile01">상품이미지</label>
                                    <div class="d-flex align-items-center">
                                        <button class="btn btn-primary waves-effect waves-themed" type="button"><i class="fal fa-search"></i></button>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="uploadFile" name="uploadFile" aria-describedby="inputGroupFileAddon03">
                                            <label class="custom-file-label" for="inputGroupFile03">선택된 파일이 없습니다.</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <img id="change_img" style="width: 250px;height: 250px;">
                                </div>
                            </div>
                            <label for="pdt_img" class="col-sm-3 col-form-label">현재 이미지</label>
                            <div class="col-sm-3">
                              <img id="curr_img" src="/admin/product/displayImage?folderName=${productVO.pro_up_folder }&fileName=s_${productVO.pro_img}" style="width: 250px;height: 250px;">
                            </div>
                        </div>
                        ...
                        <div class="my-5"></div>
                        <div class="form-group">
                            <label class="form-label" for="example-textarea"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">텍스트 영역</font></font></label>
                            <textarea class="form-control" id="pro_content" name="pro_content"rows="5">${productVO.pro_content}</textarea>
                        </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                //파일첨부 이미지 미리보기 : 파일 이미지 클릭시 "e" 값에 저장된다.
                $("#uploadFile").on("change", function(e){
                    let file = e.target.files[0]; //선택한 파일들중 첫번째 파일

                    let reader = new FileReader();//첨부된 파일을 읽기위한 파일입력 객체.
